        ...
        <div class="row justify-content-center">
            <div class="col col-4">
                ...
                <form action="../objetos/objeto_cliente.php" method="get">
                    <div class="mb-3">
                        <label for="txtNombre" class=form-label>Nit</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="txtTelefono" id="txtTelefono" placeholder="Ingrese su Nombre">
                    </div>
                    <div class="mb-3">
                        <label for="txtDireccion" class=form-label>Direccion</label>
                        <input type="text" class="form-control" name="txtDireccion" id="txtDireccion" placeholder="Ingrese su Apellido">
                    </div>
                    <div class="mb-3">
